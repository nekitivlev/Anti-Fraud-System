...
import com.example.antifraudsystem.config.AntiFraudSecurityConfig;
...
public class UserService {
    ...
    private final AntiFraudSecurityConfig securityConfig;

    @Autowired
    public UserService(UserRepository userRepository, AntiFraudSecurityConfig securityConfig) {
